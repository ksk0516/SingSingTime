...
export default {
  ...
  setup() {
    ...
    const clickLogin = function () {
      ...
      axios({
        method: "post",
        url: "http://i8c105.p.ssafy.io:8080/api/v1/auth/login",
        data: user,
      })
        .then((res) => {
          alert("로그인 성공!");
    ...
    const id_check = function () {
      ...
      axios({
        method: "get",
        url: `http://i8c105.p.ssafy.io:8080/api/v1/users/id/${signup_state.form.id}`,
      })
        .then((res) => {
    ...
    const nickname_check = function () {
      axios({
        method: "get",
        url: `http://i8c105.p.ssafy.io:8080/api/v1/users/nickname/${signup_state.form.nickname}`,
      })
        .then((res) => {
          console.log(res.data.message);
          alert(res.data.message);
